...
sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmptc_s7eed/repo/precheck_results/02_MAY_2026___20_16_11/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmptc_s7eed/repo/precheck_results/02_MAY_2026___20_16_11/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmptc_s7eed/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmptc_s7eed/repo/gds/user_project_wrapper.gds
cd /tmp/tmptc_s7eed/repo/precheck_results/02_MAY_2026___20_16_11/tmp/ext
