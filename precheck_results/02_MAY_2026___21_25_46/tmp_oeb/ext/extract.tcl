...
sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpaw9zs9cy/repo/precheck_results/02_MAY_2026___21_25_46/tmp_oeb/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpaw9zs9cy/repo/precheck_results/02_MAY_2026___21_25_46/tmp_oeb/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpaw9zs9cy/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpaw9zs9cy/repo/gds/user_project_wrapper.gds
cd /tmp/tmpaw9zs9cy/repo/precheck_results/02_MAY_2026___21_25_46/tmp_oeb/ext
